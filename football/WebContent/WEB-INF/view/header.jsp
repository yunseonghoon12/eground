...
<body style="width: 1280px; margin: 0 auto;">
	<div class="headwrap">
		<header id="header01" style="height: 60px; display: flex;">
			<div id="serchArea">
				<a href="#"><img src="/resource/images/logo.png"
					style="height: 80px; width: 120px; margin-left: 30px;"></a>
			</div>
			<ul class="headNav1">
				<li><a href="#"><img
						src="webContent/resource/images/돋보기.png"
				...
				<li><a href="#"> <img
						src="webContent/resource/images/회원.png"
						style="height: 25px; width: 25px;"></a></li>
				<li><a href="#"> <img
						src="webContent/resource/images/달력.png"
